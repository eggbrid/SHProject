package com.shpro.xus.shproject.view.views.cycleView;
...
import com.shpro.xus.shproject.view.views.cycleView.effect.DefaultTransformer;
...
//		mImageDescList=imageDesList;
		...
		for (int i = 0; i < imageCount; i++) {
			...
			if (i == 0) {
				...
				mImageViews[i].setBackgroundResource(R.drawable.home_header_cycle_dis_selected_bg);;//.setBackgroundResource(R.drawable.banner_dot_normal);
			}
